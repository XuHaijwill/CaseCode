 ...
 * Generated at: 2019-04-21 13:05:24 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t\t\t\t\tvar delBtn = $(\"<button></button>\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.addClass(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\"btn btn-danger btn-sm delete_btn\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t.append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t$(\"<span></span>\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t.addClass(\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tempIdTd).append(empNameTd).append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tgenderTd).append(emailTd).append(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdeptNameTd).append(btnTd).appendTo(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\"#emps_table tbody\");\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t//解析显示的分页信息\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tthis.deptName).attr(\"value\", this.deptId);\r\n");
